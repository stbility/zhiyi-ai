...
工作区与产物预览、联网检索、Git 仓库读写与开 PR、密钥加密与列级隔离、调用限流、RLS 隔离。

**尚未交付,不得对外宣称**:工作流状态机与后台 Worker(单次任务仍受平台 300 秒函数时限约束)、
知识库与 RAG、长期记忆、订阅与权益体系、成员管理、监控与备份回滚。
...
| 4 | Tool Registry、Agent、工作流状态机、Worker | 🟡 工具注册与智能体循环已完成;工作流状态机与 Worker 未做 |
| 5 | 文件上传、解析、RAG、长期记忆 | 🟡 文件夹上传、跨轮保留、上下文预算已完成;解析、RAG、长期记忆未做 |
